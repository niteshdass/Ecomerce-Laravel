...
<div class="features_items"><!--features_items-->
                ...
                <?php foreach($get_all_publish as $all_p){?>
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img style="height:300px;"src="{{URL::to($all_p->product_image)}}" alt="" />
                                          <h2>{{$all_p->product_price}}</h2>
                                            <p>{{$all_p->product_name}}</p>
                                            <a href="{{URL::to('/product_details/'.$all_p->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li><a href="{{URL::to('/product_details/'.$all_p->product_id)}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
